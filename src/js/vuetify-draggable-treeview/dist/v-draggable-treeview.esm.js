...
var script = Vue.extend({
    ...
    methods: {
        ...
        updateChildValue: function (value) {
            var index = this.localValue.children.findIndex(function (c) {
...
var script$1 = Vue.extend({
    ...
    methods: {
        ...
        updateItem: function (itemValue) {
            var index = this.localValue.findIndex(function (v) {
                return v.id === itemValue.id;
            });
